import useIncentiveAssortmentExcludedData from "./hook/useIncentiveAssortmentExcludedData"
...
export const IncentiveAssortmentToExclude = () => {
  const {assortmentExcludedData,isLoading}=useIncentiveAssortmentExcludedData();

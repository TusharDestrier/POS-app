  ...
  return (
    ...
    >
          ...
          <div className="payments">
            ...
            <div className="space-y-3 mb-3 text-white bg-white/20 roun shadow-md p-3">
              ...
              <div className="flex items-center space-x-2 mb-3">
                ...
                <Label htmlFor="denomination" className=''>Accept Denomination-Based Payments</Label>
              </div>
              {/* Reference Details Capturing */}
              <div className="flex items-center space-x-2">
                <Checkbox className='border-white' id="referenceDetails" />
                <Label htmlFor="referenceDetails" className=''>Allow Reference Details Capturing</Label>
              </div>
              {/* Negative Values Only */}
              <div className="flex items-center space-x-2">
                <Checkbox className='border-white' id="negativeValues" />
                <Label htmlFor="negativeValues" className=''>Accept Only Negative Payment Values</Label>
              </div>
              {/* Payment Restriction Conditions */}
              <div className="space-y-3">
                <div className="flex items-center space-x-2">
                  <Checkbox className='border-white' id="paymentRestriction" />
                  <Label htmlFor="paymentRestriction" className=''>Restrict Payments in This Mode When:</Label>
                </div>
                <div className="ml-5">
                  <RadioGroup defaultValue="comfortable">
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem className='border-white' value="itemPromotions" id="itemPromotions" />
                      <Label htmlFor="itemPromotions" className=''>Item-Level Promotions Are Applied</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem className='border-white' value="billPromotions" id="billPromotions" />
                      <Label htmlFor="billPromotions" className=''>Bill-Level Promotions Are Applied</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem className='border-white' value="anyPromotions" id="anyPromotions" />
                      <Label htmlFor="anyPromotions" className=''>Any Promotions Are Applied</Label>
                    </div>
                  </RadioGroup>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-2">
                ...
                <Label htmlFor="countBasedPayment" className=''>Count-Based Payment Transfers</Label>
              </div>
              {/* Restrict Customer Loyalty Points */}
              <div className="flex items-center space-x-2">
                <Checkbox className='border-white' id="restrictLoyaltyPoints" />
                <Label htmlFor="restrictLoyaltyPoints" className=''>Restrict Customer Loyalty Points</Label>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="payments">
        ...
        <RadioGroup defaultValue="comfortable" className="space-y-1 bg-white/20 text-white p-3 rounded-md shadow-md">
          {[

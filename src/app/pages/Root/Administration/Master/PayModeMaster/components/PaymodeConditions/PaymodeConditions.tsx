...
function PaymodeConditions() {
  ...
  const conditions = [
    { conditionId: "ADBD", label: "Accept Denomination-Based Payments" },
    { conditionId: "ARDC", label: "Allow Reference Details Capturing" },
    { conditionId: "AONPB", label: "Accept Only Negative Payment Values" },
    { conditionId: "RPTM", label: "Restrict Payments in This Mode" },
    { conditionId: "CBPT", label: "Count-Based Payment Transfers" },
    { conditionId: "RCLP", label: "Restrict Customer Loyalty Points" },
  ];
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="flex flex-row items-start space-x-3">
              <FormControl >
                <Checkbox
                  checked={field.value} // Boolean value for isEnabled
                  onCheckedChange={(checked) => field.onChange(checked)} // Update value
                />
              </FormControl>

...
export function DocumentSeriesDetailTable() {
  ...
  const modalToggler = useDocumentSeries((state) => state.toggleOpen)
  const setModalMode = useDocumentSeries((state) => state.setMode)

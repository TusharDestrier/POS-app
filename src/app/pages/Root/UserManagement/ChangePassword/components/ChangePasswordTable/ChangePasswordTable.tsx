...
import { columns } from '../ChangePasswordColumn/ChangePasswordColumn'
...
function ChangePasswordTable() {
  ...
  const openHandler = useChangePasswordStore((state) => state.toggleOpen)
  ...
  return (
    <div className="w-full">
      <div className="flex items-center py-4">
        <Input
          placeholder="Filter Change Password..."
